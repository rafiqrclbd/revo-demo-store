class Order::OnlineV1Service < RequestBaseService
  ...
  def payload
    {
      ...
      current_order: {
        ...
        order_id: ['ORDER-ONLINE-V1-', order.uid].join
      }
    }.to_json
  end

  def uri
    @uri ||= URI("#{host}/online/v1/auth")
  end

  def password
    Rails.application.secrets.full_password
  end
end
